...
COLOR_DICT = np.array([Sky, Building,  Car, Pedestrian, Unlabelled])
...
def trainGenerator(batch_size,aug_dict,train_path,image_folder,mask_folder,image_color_mode = "rgb",
...
def testGenerator(test_path,num_image = 6,target_size = (256,256),flag_multi_class = True,as_gray = False):
...
def geneTrainNpy(image_path,mask_path,flag_multi_class = True,num_class = 5,image_prefix = "image",mask_prefix = "mask",image_as_gray = False,mask_as_gray = False):
